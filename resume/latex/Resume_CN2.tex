...
\begin{document}
	...
	\begin{itemize}	
		...
		\item \textbf{微服务网关}{基于Unity3D、Android和Arduino的虚拟自行车骑行系统。}~\textbf{2019/04 $\sim$ 2019/06}
		1. 基于Spring Cloud Gateway定制开发了网关，设计数据结构与算法对路由逻辑进行优化
		2. 基于ETCD设计开发了服务注册与发现组件
		3. 设计并开发了微服务客户端，简化各业务接入过程
		\vspace{0.03in}
		
		\item \textbf{\href{https://cloud.baidu.com/product/dugo.html}{物联网车辆云}}{提供位置共享服务的App，类似于微信中的位置共享。}~~~~~~~~~~~~~~~~~\textbf{2018/07 $\sim$ 2019/02}
		1. 设计并开发车联网设备接入系统
