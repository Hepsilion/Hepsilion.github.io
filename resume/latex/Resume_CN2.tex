...
\begin{document}
	...
	\begin{itemize}	
		\item \textbf{\href{https://lbsyun.baidu.com/solutions/logisticsmap}{智能物流系统}:}{物流场景下的路线规划、划区分单、物流园区等系统。}技术负责人~~~~~~~~\textbf{2020/02 $\sim$ 至今}
		
		1. 维护与迭代百度货车路线规划API，分析并提炼客户的业务需求，设计通用的系统架构，实现私有区域规避、私有路段豁免、私有路线导航、路线解释性分析、多模式路线规划等能力;\\
