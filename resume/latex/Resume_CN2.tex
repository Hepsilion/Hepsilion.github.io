...
\begin{document}
	...
	\begin{itemize}	
		...
		\item \textbf{物流智能调度}{基于Unity3D、Android和Arduino的虚拟自行车骑行系统。}~\textbf{2019/07 $\sim$ 2020/01}
		...
		\item \textbf{微服务网关:}{为部门内产品提供服务注册、服务发现与流量分发等能力的微服务化组件}~\textbf{2019/04 $\sim$ 2019/06}
		...
		\item \textbf{\href{https://cloud.baidu.com/product/dugo.html}{物联网车辆云}:}{为车载设备提供车辆数据接入、存储、分析与控制的车联网云服务平台}~~~~~~~~~~~~~~~~~\textbf{2018/07 $\sim$ 2019/03}
